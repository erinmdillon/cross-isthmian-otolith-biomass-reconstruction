...
bchron_age_depth_raw <- read.csv("bchron_age_depth.csv",header=T)


#map sample midpoint predictions from age model onto our labeling system for sampling intervals
sample_interval <- read.csv("sampling_intervals_pacific.csv")
...
#load data
oto_families_raw <- read.csv("oto_family.csv",header=T,na.strings=".")
...
dd_pan_age_clean <- read.csv("dd_abund.csv",header=T)
