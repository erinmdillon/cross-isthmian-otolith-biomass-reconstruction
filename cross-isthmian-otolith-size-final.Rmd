...
#load raw data
oto_pac_size_raw <- read.csv("data/pacific_oto_meas.csv",header=T)
...
#check data format
head(taxa_data)
#write.csv(taxa_data,"data/taxa_data_fishbase_2025.csv") #saving copy of downloaded data
...
#write.csv(lwr_data,"data/lwr_fishbase_2025.csv") #saving copy of downloaded data
